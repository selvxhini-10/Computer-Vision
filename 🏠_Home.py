...
st.sidebar.image("https://mindy-support.com/wp-content/uploads/2022/10/types-of-image-segmentation-1.jpg", caption=None, width=None, use_column_width=None, clamp=False, channels="RGB", output_format="auto", use_container_width=False)
...
st.sidebar.link_button("Go to gallery", "https://streamlit.io/gallery")

import streamlit as st

# Using object notation
add_selectbox = st.sidebar.selectbox(
    "Take a look at these CV projects!",
